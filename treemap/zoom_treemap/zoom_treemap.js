...
(function() {
  $(document).ready(function() {
    var childEnterTransition, childUpdateTransition, children, childrenCells, data, node, nodes, parentCells, parentEnterTransition, parentUpdateTransition, parents, root;
    data = zoom_treemap;
    window.height = 500;
    window.width = 500;
