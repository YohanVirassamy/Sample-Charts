...
(function() {
  $(document).ready(function() {
    ...
    return $.ajax({
      ...
      var arc, breadcrumb, breadcrumbPoints, buildHierarchy, createVisualization, drawLegend, getAncestors, height, initializeBreadcrumbTrail, mouseleave, mouseover, partition, radius, toggleLegend, totalSize, updateBreadcrumbs, vis, width;
      ...
      updateBreadcrumbs = function(nodeArray, percentageString) {
        ...
        entering.append("svg:text").attr("x", (breadcrumb.b_width + breadcrumb.b_tip_tail) / 2).attr("y", breadcrumb.b_height / 2).attr("dy", "0.35em").attr("text-anchor", "middle").text(percentageString);
